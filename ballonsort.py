...
#===[FUNCTIONS]===#
def swap(list,pos1,pos2):           #Swap 2 items in list
...
def sort(list):
    ...
    while True:                                                         #Makes a never ending loop
        ...
        plt.title("Iteration: {x}".format(x=it))                        #Gives the plot a title and the current iteration   
